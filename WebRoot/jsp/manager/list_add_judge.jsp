...
<head>
	...
	<script>
	function returnhome(){
	location.href = "manager_judge.servlet?";
	}
...
<body>
	...
	<s:form id="exl_submit" action="list_add_judge" method="post" enctype="multipart/form-data">
	<br><br>
	<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<br>
		<div class="text">
			<input type="file" id="files" name="list_add_judge" value="路径"/>
		</div>
	</s:form>
	<br><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="jsp/manager/example_judge.jsp">
